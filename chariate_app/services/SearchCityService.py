...
'''
creates new version from given original version with rewriting descriptions and relations

returns result set as:
    new_version <- created object
    descriptions <- created descrpitions for new version
    relations
        in <- relations, where new version is on IN side of relation
        out <- same, but for OUT side of relation
'''
